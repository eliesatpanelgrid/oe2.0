#!/bin/sh
#https://raw.githubusercontent.com/eliesatpanelgrid/oe2.0/main/addons/multiquickbutton/multiquickbutton-obh.sh
...
git_url="https://raw.githubusercontent.com/eliesatpanelgrid/oe2.0/main/$section/$plugin1"
