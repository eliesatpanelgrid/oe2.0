#!/bin/sh
#https://raw.githubusercontent.com/eliesatpanelgrid/oe2.0/main/addons/fullbackup/fullbackup.sh

#!/bin/sh

if ! grep -qi "openpli" /etc/image-version 2>/dev/null; then
    echo "> Image not supported. This plugin requires OpenPLi."
    exit 1
fi

echo "> OpenPLi detected."
