#!/bin/sh
#https://raw.githubusercontent.com/eliesatpanelgrid/oe2.0/main/addons/spinner-selector/spinner-selector.sh

# Configuration
#########################################
plugin="spinner-selector"
rm="SpinnerSelector"
section="addons"
...
rm -rf /usr/lib/enigma2/python/Plugins/Extensions/SpinnerSelector
...
if [ -f /usr/uninstall/SpinnerSelector.nab ]; then
	rm -rf /usr/lib/enigma2/python/Plugins/Extensions/SpinnerSelector
        rm -rf /usr/share/enigma2/Spinner
fi
...
if [ -e /usr/share/enigma2/skin_default/spinner ]; then
	mkdir -p /usr/share/enigma2/Spinner/Original
	cp /usr/share/enigma2/skin_default/spinner/* -r /usr/share/enigma2/Spinner/Original
else
	:
fi
