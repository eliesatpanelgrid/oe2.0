#!/bin/sh
#https://raw.githubusercontent.com/eliesatpanelgrid/oe2.0/main/addons/subssupport/subssupport.sh
...
# Required packages
DEPS="unrar python3-codecs python3-compression python3-core python3-difflib python3-json python3-requests python3-xmlrpc python3-beautifulsoup4"
