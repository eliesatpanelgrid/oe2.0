#!/bin/sh
#https://raw.githubusercontent.com/eliesatpanelgrid/oe2.0/main/addons/novaler/novalerstore/novalerstore.sh
...
ipk_file="${package}-py${PY}_${version}_all.ipk"
