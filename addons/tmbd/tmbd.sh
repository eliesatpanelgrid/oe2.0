#!/bin/sh
#https://raw.githubusercontent.com/eliesatpanelgrid/oe2.0/main/addons/tmbd/tmbd.sh
...
plugin_path1="/usr/lib/enigma2/python/Plugins/Extensions/$rm1"
...
check_and_remove_package() {
  if [ -d "$plugin_path" ] || [ -d "$plugin_path1" ]; then
    echo "> removing package old version please wait..."
    sleep 3 
    rm -rf "$plugin_path" "$plugin_path1" > /dev/null 2>&1
