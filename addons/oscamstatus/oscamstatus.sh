#!/bin/sh
#https://raw.githubusercontent.com/eliesatpanelgrid/oe2.0/main/addons/oscamstatus/oscamstatus.sh
...
rm -rf /usr/lib/enigma2/python/Plugins/Extensions/PermanentTest/
rm -rf /usr/lib/enigma2/python/Components/Converter/Kitte888_CS*
rm -rf /usr/lib/enigma2/python/Components/Converter/Kitte_888TestConnectionInternet.py
