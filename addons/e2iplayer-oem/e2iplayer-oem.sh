#!/bin/sh
#https://raw.githubusercontent.com/eliesatpanelgrid/oe2.0/main/addons/e2iplayer-oem/e2iplayer-oem.sh

# Configuration
#########################################
plugin="e2iplayer-oem"
rm="IPTVPlayer"
section="addons"
...
# Required packages
DEPS="enigma2-plugin-extensions-e2iplayer-deps
exteplayer3
gstplayer
python3-sqlite3
python3-pycurl
...
wget -q "--no-check-certificate" https://github.com/popking159/mye2iplayer/raw/main/update_e2iplayer_patch.sh -O - | /bin/sh
