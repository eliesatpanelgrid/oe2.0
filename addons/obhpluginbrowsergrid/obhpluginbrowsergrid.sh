#!/bin/sh
#https://raw.githubusercontent.com/eliesatpanelgrid/oe2.0/main/addons/obhpluginbrowsergrid/obhpluginbrowsergrid.sh

# Configuration
#########################################
plugin="obhpluginbrowsergrid"
rm="OBHPluginBrowserGrid"
section="addons"

git_url="https://raw.githubusercontent.com/eliesatpanelgrid/oe2.0/main/$section/$plugin"
version=$(wget $git_url/version -qO- | awk 'NR==1')
plugin_path="/usr/lib/enigma2/python/Plugins/SystemPlugins/$rm"
