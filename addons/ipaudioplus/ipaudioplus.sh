...
chmod -R 755 /usr/lib/enigma2/python/Plugins/Extensions/IPAudioPlus 2>/dev/null || true
rm -f /usr/lib/enigma2/python/Plugins/Extensions/IPAudioPlus/plugin.so 2>/dev/null || true
find /usr/lib/enigma2/python/Plugins/Extensions/IPAudioPlus -name '*.pyc' -delete 2>/dev/null || rm -f /usr/lib/enigma2/python/Plugins/Extensions/IPAudioPlus/*.pyc 2>/dev/null || true
find /usr/lib/enigma2/python/Plugins/Extensions/IPAudioPlus -name '*.pyo' -delete 2>/dev/null || rm -f /usr/lib/enigma2/python/Plugins/Extensions/IPAudioPlus/*.pyo 2>/dev/null || true
find /usr/lib/enigma2/python/Plugins/Extensions/IPAudioPlus -type d -name '__pycache__' -exec rm -rf {} + 2>/dev/null || rm -rf /usr/lib/enigma2/python/Plugins/Extensions/IPAudioPlus/__pycache__ 2>/dev/null || true
amixer set ALL on 2>/dev/null || true
amixer set Master unmute 2>/dev/null || true
amixer -q set Master 100% unmute 2>/dev/null || true
sync
