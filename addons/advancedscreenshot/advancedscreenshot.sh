#!/bin/sh
#https://raw.githubusercontent.com/eliesatpanelgrid/oe2.0/main/addons/advancedscreenshot/advancedscreenshot.sh

# Configuration
#########################################
plugin="advancedscreenshot"
rm="AdvancedScreenshot"
section="addons"
