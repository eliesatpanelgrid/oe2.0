#!/bin/sh
#https://raw.githubusercontent.com/eliesatpanelgrid/oe2.0/main/addons/iptvarchive/iptvarchive.sh
...
if [ $? -eq 0 ]; then
    ...
    listfile="/var/lib/$pkg/info/enigma2-plugin-extensions--${PluginName,,}.list"
