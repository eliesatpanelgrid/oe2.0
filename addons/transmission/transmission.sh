#!/bin/sh
#https://raw.githubusercontent.com/eliesatpanelgrid/oe2.0/main/addons/transmission/transmission.sh
...
rm -rf /usr/lib/enigma2/python/Plugins/Extensions/Stremio > /dev/null 2>&1
