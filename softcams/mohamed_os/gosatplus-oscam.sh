...
# Configuration
pack="enigma2-plugin-softcams-gosatplus-oscam"
version="11966-emu-r802_all"
package="$pack"
...
url="https://raw.githubusercontent.com/eliesatpanelgrid/oe2.0/main/softcams/mohamed_os/$ipk"
temp_dir="/tmp"
