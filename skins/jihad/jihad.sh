#!/bin/sh
#https://raw.githubusercontent.com/eliesatpanelgrid/oe2.0/main/skins/jihad/jihad.sh
...
url="https://github.com/eliesatpanelgrid/oe2.0/releases/download/Oldies/jihad.tar.gz"
temp_dir="/tmp"
...
rm -rf /usr/lib/enigma2/python/Plugins/Extensions/Jihad  > /dev/null 2>&1
rm -r /usr/lib/enigma2/python/Components/Jihad* > /dev/null 2>&1
rm -r /usr/lib/enigma2/python/Components/Converter/Jihad* > /dev/null 2>&1
rm -r /usr/lib/enigma2/python/Components/Renderer/Jihad* > /dev/null 2>&1
