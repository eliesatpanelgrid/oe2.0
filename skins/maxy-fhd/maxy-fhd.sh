#!/bin/sh
#https://raw.githubusercontent.com/eliesatpanelgrid/oe2.0/main/skins/maxy-fhd/maxy-fhd.sh
...
SKINDIR='/usr/share/enigma2/Maxy-FHD'
TMPDIR='/tmp'
set -e
if grep -qs -i "openATV" /etc/image-version; then
    ...
    echo "even you do not have supported image , you can try Maxy-FHD"
fi
sleep 2
