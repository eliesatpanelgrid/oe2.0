#!/bin/sh
#https://raw.githubusercontent.com/eliesatpanelgrid/oe2.0/main/skins/metrixconfluencexp/metrixconfluencexp.sh

# Configuration
#########################################
plugin="metrixconfluencexp"
rm="MetriXconfluencExp"
section="skins"
