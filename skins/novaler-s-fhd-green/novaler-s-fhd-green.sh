#!/bin/sh
#https://raw.githubusercontent.com/eliesatpanelgrid/oe2.0/main/skins/novaler-s-fhd-green/novaler-s-fhd-green.sh

# Configuration
#########################################
plugin="novaler-s-fhd-green"
rm="Novaler-S-FHD-Green"
section="skins"
