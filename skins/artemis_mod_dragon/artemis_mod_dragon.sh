#!/bin/sh
#https://raw.githubusercontent.com/eliesatpanelgrid/oe2.0/main/skins/artemis_mod_dragon/artemis_mod_dragon.sh

# Configuration
#########################################
plugin="artemis_mod_dragon"
rm="Artemis_mod_dragon"
section="skins"
...
rm -r /usr/share/enigma2/Artemis_mod_dragon > /dev/null 2>&1
rm -r /usr/lib/enigma2/python/Plugins/Extensions/Artemis_mod_dragon > /dev/null 2>&1
rm -r /usr/lib/enigma2/python/Plugins/Extensions/OAWeather > /dev/null 2>&1
...
# Required packages
DEPS="enigma2-plugin-extensions-oaweather"
