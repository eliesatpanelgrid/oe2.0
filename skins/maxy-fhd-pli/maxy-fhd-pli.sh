#!/bin/sh
#https://raw.githubusercontent.com/eliesatpanelgrid/oe2.0/main/skins/maxy-fhd-pli/maxy-fhd-pli.sh
...
SKINDIR='/usr/share/enigma2/Maxy-FHD-PLI'
TMPDIR='/tmp'
...
cp /usr/share/enigma2/Maxy-FHD-PLI/main/boximage.png $SKINDIR/boximage.png
fi
