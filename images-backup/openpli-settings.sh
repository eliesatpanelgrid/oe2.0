...
config.autolanguage.audio_autoselect2=eng
config.autolanguage.audio_epglanguage=eng
config.autolanguage.audio_epglanguage_alternative=ara
config.av.bypassEdidChecking=True
config.av.edid_override=False
...
config.av.volume_stepsize=5
config.misc.enableGeolocation=False
config.misc.firstrun=False
config.misc.hotkey.info=Infobar/openFavouritesList
config.misc.hotkey.info_long=Infobar/openSatellitesList
...
config.misc.softcam_streamrelay_delay=100
config.misc.startCounter=44
...
config.Nims.0.advanced.sat.560.lnb=1
config.Nims.0.advanced.sat.560.rotorposition=56
config.Nims.0.advanced.sat.560.usals=False
...
config.Nims.0.advanced.sats=705
...
config.Nims.0.lastsatrotorposition=3530
config.plugins.Aglare.ChannSelector=channellist_big_mini_tv
config.plugins.Aglare.colorSelector=color1
config.plugins.Aglare.EventView=eventview_7_posters
config.plugins.Aglare.InfobarDate=infobar_date1
config.plugins.Aglare.InfobarPosterx=infobar_posters_posterx_on
config.plugins.Aglare.InfobarWeather=infobar_MSNweather
config.plugins.Aglare.SecondInfobarPosterx=secondinfobar_posters_posterx_on
config.plugins.Aglare.SecondInfobarStyle=secondinfobar_base3
config.plugins.Aglare.SecondInfobarWeather=secondinfobar_MSNweather
...
config.plugins.AJPanel.showInExtensionMenu=False
...
config.plugins.extra_epgimport.last_import=26 Aug 2026 09:01:34, 8389
config.plugins.filecommander.path_default=None
config.plugins.filecommander.path_left=/media/hdd/Ajpanel_Eliesatpanel/ajpanel_pkg_download/panels/
config.plugins.filecommander.savedir_left=True
config.plugins.filecommander.savedir_right=True
config.plugins.filecommander.script_messagelen=3
config.plugins.filecommander.script_priority_ionice=0
config.plugins.filecommander.script_priority_nice=0
config.plugins.filecommander.sortFiles_left=0.0
config.plugins.filecommander.sortFiles_right=0.0
config.plugins.filecommander.unknown_extension_as_text=True
config.plugins.furybis.notifications=False
config.plugins.iptvplayer.cmdwrappath=/usr/lib/enigma2/python/Plugins/Extensions/IPTVPlayer/bin/cmdwrap
config.plugins.iptvplayer.dukpath=/usr/bin/duk
...
config.plugins.iptvplayer.TorrServerpath=/usr/lib/enigma2/python/Plugins/Extensions/IPTVPlayer/bin/TorrServer
config.plugins.iptvplayer.uchardetpath=/usr/bin/uchardet
config.plugins.iptvplayer.wgetpath=wget
config.plugins.OSDPositionSetup.dst_height=523
config.plugins.OSDPositionSetup.dst_left=35
config.plugins.OSDPositionSetup.dst_top=27
config.plugins.OSDPositionSetup.dst_width=648
...
config.skin.primary_skin=SimpleGray-FHD/skin.xml
...
config.tv.lastservice=1:0:1:711:12:800:DCA0000:0:0:0:
config.usage.alternative_number_mode=True
config.usage.changebouquet_set_history=True
config.usage.channelselection_preview=True
config.usage.crypto_icon_mode=1
config.usage.menu_show_numbers=menu&plugins
config.usage.menu_sort_mode=user
config.usage.menu_sort_weight={'mainmenu': {'submenu': {'timer_edit': {'sort': 40}, 'information': {'sort': 50}, 'plugin_selection': {'sort': 60}, 'setup': {'sort': 70}, 'shutdown': {'sort': 80}, 'BouquetMakerXtream': {'sort': 30, 'hidden': 1}, 'EStalker': {'sort': 90, 'hidden': 1}, 'eliesat_panel_grid': {'sort': 20}, 'servicescanupdates_mainmenu': {'sort': 100, 'hidden': 1}, 'simply_sports': {'sort': 10, 'hidden': 1}, 'XStreamity': {'sort': 110, 'hidden': 1}}}}
