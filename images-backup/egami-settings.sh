...
config.plugins.iptvplayer.SciezkaCache=/media/hdd/IPTVCache/
config.plugins.iptvplayer.torserver_config=/usr/lib/enigma2/python/Plugins/Extensions/IPTVPlayer/bin/config
config.plugins.iptvplayer.torserver_path=/usr/lib/enigma2/python/Plugins/Extensions/IPTVPlayer/bin/TorrServer
config.plugins.iptvplayer.uchardetpath=/usr/bin/uchardet
config.plugins.iptvplayer.updateLastCheckedVersion=2025.03.01.00
