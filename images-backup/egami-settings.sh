...
config.crash.lastfulljobtrashtime=1778841397
config.lcd.bright=8
...
config.misc.nextWakeup=1778846265,-1,-1,0,0,-1,0
config.misc.SettingsVersion=1.1
config.misc.softcams=OSCam_11.725-r798
config.misc.startCounter=17
...
config.osd.dst_height=525
config.osd.dst_left=38
config.osd.dst_top=27
config.osd.dst_width=644
...
config.plugins.EGPermanentClock.position_x=235
...
config.tv.lastroot=1:7:1:0:0:0:0:0:0:0:FROM BOUQUET "bouquets.tv" ORDER BY bouquet;1:7:1:0:0:0:0:0:0:0:FROM BOUQUET "userbouquet.7_0w_ku_band_nilesat_201_301___eutelsat_7_west_a___services__tv_.tv" ORDER BY bouquet:[Fav] 7.0W Nilesat & Eutelsat 8;
config.tv.lastservice=1:0:19:6F:2:FFFF:DCA2CB9:0:0:0:
